...
using TicketsGeneratorServices.Api.Configuration.Swagger;
using TicketsGeneratorServices.Api.Configuration.Swagger.Filters;
...
namespace TicketsGeneratorServices.Api.Configuration
{
    public static class SwaggerConfigurationHostingExtensions
    {
        ...
        public static IApplicationBuilder UseSwaggerInApp(this IApplicationBuilder builder)
        {
            ...
            {
                options.DocumentTitle = "TicketsGenerator API";
